...
-- Restore the FOREIGN KEY on flow_element_instance_key that was removed in the up migration.
CREATE TABLE decision_instance_new(
    ...
    FOREIGN KEY (flow_element_instance_key) REFERENCES flow_element_instance(key)
);
